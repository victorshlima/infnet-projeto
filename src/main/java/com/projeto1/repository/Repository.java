...
public class Repository {
    ...
    public void inicializaBase(){
        ...
        getUsuarios().add(new Usuario(UUID.randomUUID(),"jasmin", "123", Status.ATIVO,
                ...
                new Conta(LocalDateTime.now(), LocalDateTime.now(), BigDecimal.valueOf(1000.00),  historicoMovimentacoes )));
        ...
        getUsuarios().add(new Usuario(UUID.randomUUID(), "joao", "123", Status.ATIVO,
                ...
                new Conta(LocalDateTime.now(), LocalDateTime.now(), BigDecimal.valueOf(2000.00), historicoMovimentacoesJoao )));
        ...
        getUsuarios().add(new Usuario(UUID.randomUUID(), "Maria", "123", Status.BLOQUEADO,
                ...
                new Conta(LocalDateTime.now(), LocalDateTime.now(), BigDecimal.valueOf(3000.00), historicoMovimentacoes3 )));
    }
